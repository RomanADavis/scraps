...
int main(void)
{
	...
	printf("Variables of type short store values from %d to %d.\n", SHRT_MIN, 
																SHRT_MAX);
	printf("Variables of type unsigned short store values 0 to %u.\n", USHRT_MAX);
	...
	printf("\nThe size of the smallest positive non-zero value of float is %.3e\n", 
																FLT_MIN);
	printf("The size of the largest value of type float is %.3e.\n", FLT_MAX);
	printf("The size of the smallest non-zero value of double is %.3e.\n", DBL_MIN);
	...
	printf("The size of the smallest non-zero value of type long double is %.3Le\n.",
																LDBL_MIN);
	printf("The size of the largest value of type double is %.3Le.\n", LDBL_MAX);
	
	printf("\nVariables of type float provide %u decimal digits percision.\n", 
																FLT_DIG);
	printf("Variables of type double provide %u decimal digits percision.\n", DBL_DIG);
	printf("Variables of type long double provide %u decimal digits percision.\n", 
																LDBL_DIG);
	return 0;
}
