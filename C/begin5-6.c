...
********************************************************/
	...
	int headsize[12] =					// Value is 1/8 inches
		{164, 166, 169, 172, 175, 181, 184, 188, 191, 197};
 	...
 	* Either you head corresponds to the 1st headsize element or	*
 	...
 	***************************************************************/
 	...
 	else
 	{
 		...
 		{
 			// Find head size i headsize array
 	...
 	else // if no hat found, the had is too small, or too large
 	{
 		if(your_head < headsize[0])			// Check for too small
 			printf("\nYou are a proverbial pinhead. No hat for"
 													" you I'm afra;d.\n");
 		else								// Must be too large
 			printf("\nYou, in tuchnical parlance, are a fathead."
